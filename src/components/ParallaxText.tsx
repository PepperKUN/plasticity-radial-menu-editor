...
import { motion, useSpring, useTransform, useMotionValue, useVelocity, useAnimationFrame, wrap, MotionValue } from "motion/react";
...
const ParallaxText:React.FC<ParallaxProps>  = ({
    ...
    const rawX = useTransform(baseX, (v) => `${wrap(6.25, -6.25, v)}%`);

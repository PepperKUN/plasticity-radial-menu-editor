...
const useListItemStore = create<ListItemState>((set) => ({
    listItems: [{
        ...
        items: [
            ...
            { id: 36, label: 'Export 3mf', icon: 'export-3mf', command: 'command:export3mf', isAdd: false},
        ...
        items: [
            ...
            { id: 151, label: 'Selection mode: set control-point', icon: 'selection-mode-set-control-point', command: 'selection:mode:set:control-point', isAdd: false},

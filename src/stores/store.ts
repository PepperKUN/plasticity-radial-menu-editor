...
const useListItemStore = create<ListItemState>((set) => ({
    listItems: [{
        ...
        commandType: 'Snaps',
        items: [
            { id: 123, label: 'Grid: decrease grid size', icon: 'grid-decrease-grid-size', command: 'viewport:grid:decr', isAdd: false},
            { id: 124, label: 'Grid: increase grid size', icon: 'grid-increase-grid-size', command: 'viewport:grid:incr', isAdd: false},
            { id: 125, label: 'Grid: toggle grid snapping', icon: 'snaps-toggle-grid', command: 'snaps:toggle-grid', isAdd: false},
            { id: 126, label: 'Toggle object snapping', icon: 'snaps-toggle-snap', command: 'snaps:toggle-snap', isAdd: false},
        ]
    },{
        commandType: 'Misc',
        items: [
            { id: 127, label: 'New window', icon: 'app-new-window', command: 'app:new-window', isAdd: false},
            { id: 128, label: 'Quit', icon: 'app-quit', command: 'app:quit', isAdd: false},
            { id: 129, label: 'Repeat last command', icon: 'edit-repeat-last-command', command: 'edit:repeat-last-command', isAdd: false},
            { id: 130, label: 'Sidebar: toggle left', icon: 'sidebar-toggle-left', command: 'view:sidebar:toggle-left', isAdd: false},
            { id: 131, label: 'Sidebar: toggle right', icon: 'sidebar-toggle-right', command: 'view:sidebar:toggle-right', isAdd: false},
        ]
    },{
        commandType: 'Orbit',
        items: [
            { id: 132, label: 'Orbit: dolly in', icon: 'orbit-dolly-in', command: 'orbit:dolly:in', isAdd: false},
            { id: 133, label: 'Orbit: dolly out', icon: 'orbit-dolly-out', command: 'orbit:dolly:out', isAdd: false},
            { id: 134, label: 'Orbit: pan down', icon: 'Orbit-pan-down', command: 'orbit:pan:down', isAdd: false},
            { id: 136, label: 'Orbit: pan left', icon: 'Orbit-pan-left', command: 'orbit:pan:left', isAdd: false},
            { id: 137, label: 'Orbit: pan right', icon: 'Orbit-pan-right', command: 'orbit:pan:right', isAdd: false},
            { id: 138, label: 'Orbit: pan up', icon: 'Orbit-pan-up', command: 'orbit:pan:up', isAdd: false},
            { id: 139, label: 'Orbit: rotate down', icon: 'Orbit-pan-up', command: 'orbit:pan:up', isAdd: false},
            { id: 140, label: 'Orbit: rotate left', icon: 'Orbit-rotate-left', command: 'orbit:rotate:left', isAdd: false},
            { id: 141, label: 'Orbit: rotate right', icon: 'Orbit-rotate-right', command: 'orbit:rotate:right', isAdd: false},
            { id: 142, label: 'Orbit: rotate up', icon: 'Orbit-rotate-up', command: 'orbit:rotate:up', isAdd: false},
        ]
    },{
        ...
        items: [
            ...
            { id: 156, label: 'Selection: toggle solid', icon: 'selection-toggle-solid', command: 'selection:toggle:solid', isAdd: false},
        ]
    },{
        commandType: 'Viewport',
        items: [
            { id: 157, label: 'Viewport: focus', icon: 'viewport-focus', command: 'viewport:focus', isAdd: false},
            { id: 158, label: 'Viewport: navigate to back', icon: 'viewport-navigate-back', command: 'viewport:navigate:back', isAdd: false},
            { id: 159, label: 'Viewport: navigate to bottom', icon: 'viewport-navigate-bottom', command: 'viewport:navigate:bottom', isAdd: false},
            { id: 160, label: 'Viewport: navigate to front', icon: 'viewport-navigate-front', command: 'viewport:navigate:front', isAdd: false},
            { id: 161, label: 'Viewport: navigate to left', icon: 'viewport-navigate-left', command: 'viewport:navigate:left', isAdd: false},
            { id: 162, label: 'Viewport: navigate to right', icon: 'viewport-navigate-right', command: 'viewport:navigate:right', isAdd: false},
            { id: 163, label: 'Viewport: navigate to selection', icon: 'viewport-navigate-selection', command: 'viewport:navigate:selection', isAdd: false},
            { id: 164, label: 'Viewport: navigate to top', icon: 'viewport-navigate-top', command: 'viewport:navigate:top', isAdd: false},
            { id: 165, label: 'Viewport: navigate to top', icon: 'viewport-navigate-top', command: 'viewport:navigate:top', isAdd: false},
            { id: 166, label: 'Viewport: toggle curves', icon: 'viewport-toggle-curves', command: 'viewport:toggle-curves', isAdd: false},
            { id: 167, label: 'Viewport: toggle edges', icon: 'viewport-toggle-edges', command: 'viewport:toggle-edges', isAdd: false},
            { id: 168, label: 'Viewport: toggle faces', icon: 'viewport-toggle-faces', command: 'viewport:toggle-faces', isAdd: false},
            { id: 169, label: 'Viewport: toggle orthographic camera', icon: 'viewport-toggle-orthographic', command: 'viewport:toggle-orthographic', isAdd: false},
            { id: 170, label: 'Viewport: toggle overlays', icon: 'viewport-toggle-overlays', command: 'viewport:toggle-overlays', isAdd: false},
            { id: 171, label: 'Viewport: toggle render mode', icon: 'viewport-toggle-render-mode', command: 'viewport:toggle-render-mode', isAdd: false},
            { id: 172, label: 'Viewport: toggle x ray', icon: 'viewport-toggle-x-ray', command: 'viewport:toggle-x-ray', isAdd: false},
        ]
    }],
